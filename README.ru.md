...
- **Защита от prompt injection** — Защита от атак типа CVE-2026-25253 с многоуровневым обнаружением паттернов
...
ClosedPaw поддерживает высокое качество кода через комплексное тестирование:

| Инструмент | Назначение | Покрытие |
|------------|------------|----------|
| **pytest** | Unit и интеграционные тесты | 19+ проходящих тестов |
| **pytest-asyncio** | Поддержка async тестов | Полное async покрытие |
| **ruff** | Python линтинг | Ноль ошибок |
| **bandit** | Сканирование безопасности | Ноль проблем |
| **coverage** | Отслеживание покрытия | HTML + XML отчёты |
...
Готовый Docker-образ доступен в GitHub Container Registry:
